 ...
 */
public abstract class RabbitMqConsumer implements MessageConsumer {
    ...
    public RabbitMqConsumer(String exchange, String queueName, String[] bindingKeys) {
        this(DEFAULT_HOST, exchange, queueName, bindingKeys);
    }

    public RabbitMqConsumer(String host, String exchange, String queueName, String[] bindingKeys) {
        this.host = host;
    ...
    public void consume() throws IOException, TimeoutException {
        ...
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                try {
                    consume((MqMessage) MessageConvert.byteToObject(body));
                } finally {
